...
class Department:
    ...
    def staff(self):
        """ Return list of staff associated with the current department """
        from models.staff import Staff  # Assuming you have a Staff model
        sql = """
            SELECT * FROM staff
            WHERE department_id = ?
        """
        ...
        return [Staff.instance_from_db(row) for row in rows]
